package com.bottomlord.projects.user.domain;

import com.bottomlord.projects.user.validator.UserValid;
 ...
 * @since 1.0
 */
@UserValid(maxPasswordLen = 32, checkEmail = false, checkPhone = false)
